...
| exp          | Exponent                 | Returns every value of the left expression, to the exponent of the first value on the right. |
...
| min          | Minimum Value            | Outputs the smallest numeric value from the result of the expression left of the operator |
